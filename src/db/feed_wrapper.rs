...
pub trait FeedWrapper {
    ...
    // fn create_feeds(self: Box<Self>, feeds: Vec<model::Feed>) -> Vec<DbResult<model::Feed>> {
    //     let mut results: Vec<DbResult<model::Feed>> = Vec::new();

    //     for feed in feeds {
    //         results.push(self.create_feed(feed));
    //     }
    ...
    // fn get_feeds(self: Box<Self>, uuids: Vec<Uuid>) -> Vec<DbResult<model::Feed>> {
    //     let mut results: Vec<DbResult<model::Feed>> = Vec::new();

    //     for _uuid in uuids {
    //         results.push(self.get_feed(_uuid));
    //     }
    ...
    // fn update_feeds(self: Box<Self>, feeds: Vec<model::Feed>) -> Vec<DbResult<model::Feed>> {
    //     let mut results: Vec<DbResult<model::Feed>> = Vec::new();

    //     for feed in feeds {
    //         results.push(self.update_feed(feed));
    //     }
    ...
    // fn delete_feeds(self: Box<Self>, uuids: Vec<Uuid>) -> Vec<DbResult<Report<String>>> {
    //     let mut results: Vec<DbResult<Report<String>>> = Vec::new();

    //     for _uuid in uuids {
    //         results.push(self.delete_feed(_uuid));
    //     }
    ...
    // fn get_feeds_checksum(self: Box<Self>, uuids: Vec<Uuid>) -> Vec<DbResult<String>> {
    //     let mut results: Vec<DbResult<String>> = Vec::new();

    //     for _uuid in uuids {
    //         results.push(self.get_feed_checksum(_uuid));
    //     }
